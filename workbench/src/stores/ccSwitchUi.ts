...
export const useCcSwitchUiStore = defineStore("ccSwitchUi", () => {
  ...
  const FALLBACK_TEMPLATES: CcSwitchTemplate[] = [
    { id: "codesome-v3", name: "Codesome V3", key_prefix: "sk-",
      ...
      codex_endpoint_native: "https://cc.codesome.ai/v1", codex_api_format: "anthropic" },
    { id: "codesome-2in1", name: "Codesome 二合一", key_prefix: "cr-",
      ...
      codex_endpoint_native: "https://v5.codesome.cn/openai", codex_api_format: "anthropic" },
    { id: "deepseek", name: "deepseek",
      claude_endpoint: "https://api.deepseek.com/anthropic",
      codex_endpoint: "https://api.deepseek.com/anthropic",
      codex_endpoint_native: "https://api.deepseek.com", codex_api_format: "anthropic" },
    { id: "volcengine-ark", name: "volcengine-ark",
      ...
      codex_endpoint_native: "https://ark.cn-beijing.volces.com/api/v3", codex_api_format: "anthropic" },
    { id: "zhipu", name: "zhipu",
      claude_endpoint: "https://open.bigmodel.cn/api/anthropic",
      codex_endpoint: "https://open.bigmodel.cn/api/anthropic",
      codex_endpoint_native: "https://open.bigmodel.cn/api/paas/v4", codex_api_format: "anthropic" },
    { id: "kimi", name: "kimi",
