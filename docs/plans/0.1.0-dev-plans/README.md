...
| A 链（P0） | **A1 ✅ / A2 ✅ / A3 ✅ / A4 aisc update ✅（2026-09-16：rename dance 原子自更新+回退副本+final-only 通道+--from-file/--rebuild；16 例矩阵 + pytest 1271）**；余 A5-A9+ `aisc bundle fetch` 底座 + `aisc update`（sidecar 热换编排）+ 工具更新合一入口 + Workbench 自更新 + 0.1.0 final/PyPI 收口（Release 全量资产 + PyPI 首发） | 待做 | [a-pypi-and-update.md](a-pypi-and-update.md) |
