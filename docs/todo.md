...
- [ ] docker 缓存自动清理
- [ ] 设备性能受限情况下，如何保证稳定运行
- [ ] cli run在存在容器的情况下禁止使用（2026-09-19 ）
- [ ] workbench 内 docker 容器/镜像的简单查询与管理（镜像删除、容器删除/停止等常用操作；2026-09-20 手测反馈，破坏性操作边界待立计划裁决）——计划已立：docker-management.md（D-12）
